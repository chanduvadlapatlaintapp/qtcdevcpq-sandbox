// @ts-check
/**
 * agenticQtcRegressionSuite.spec.js
 *
 * Full regression suite (intended for the scheduler) — the one-draft ("open the
 * existing quote") variant of agenticQtcFullSuite. Runs ONLY the one-draft ("one"
 * bucket) scenarios; the 0-draft and 2+-draft variants are removed (not skipped)
 * so the report isn't dominated by architectural bucket-skips.
 *
 * Pre-condition: the scoped account's first/selected contract must have exactly 1
 * current draft (default "Bates White" → CONT-058245/Q-84306; or QTC_CONTRACT_ID).
 *
 * Groups (one-draft scenario each): 1 Account Search · 2 OSA Selector · 3 App Nav ·
 *   4 Editor Core · 5 Editor Buttons · 6 Contact Update · 7 Start Date Change ·
 *   8 Start Date Boundary · 9 Qty Increase · 10 Qty Decrease · 11 Qty Increase
 *   Segments · 12 Qty Decrease Segments · 13 Metrics · 14 Qty Increase Non-Segment ·
 *   15 Qty Increase Bundle Segments · 17 Qty Decrease Non-Segment ·
 *   19 Qty Decrease Bundle Segments.  (16 & 18 removed)
 *
 * Key behaviours:
...
//   QTC process, so "Bundle Non-Segment" qty increase/decrease are not genuine
//   scenarios and have been deleted (was: Qty Increase Bundle Non-Segment).
// ─────────────────────────────────────────────────────────────────────────────
...
//   QTC process (see GROUP 16) — was: Qty Decrease Bundle Non-Segment.
// ─────────────────────────────────────────────────────────────────────────────
