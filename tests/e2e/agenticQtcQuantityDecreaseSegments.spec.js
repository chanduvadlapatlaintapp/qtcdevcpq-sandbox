...
async function runSegmentsDecrease(ctx) {
  ...
  buildRichResults({
    ...
    extra: {
      productA: { name: productA.productName, prior: priorA, before: beforeA, expected: finalExpectedA, actualDb: dbQtysA, rule: 'Year 1 propagates + per-segment floor at priorQuantity' },
