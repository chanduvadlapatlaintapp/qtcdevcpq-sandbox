...
export default class PortfolioAnalysis extends LightningElement {
    ...
    // ========== Filter State (from Contracts tab) ==========
    _filteredSubscriptions = null;
    ...
    handleFilterChange(event) {
        this._filteredSubscriptions = event.detail.subscriptions;
    }
    ...
    handleExportExcel() {
        ...
        try {
            const subsToExport = this._filteredSubscriptions ?? this.subscriptions;
    ...
    async loadAccountData(accountId, accountName) {
        ...
        this.invoiceMap = {};
        this.invoiceError = null;
        this._filteredSubscriptions = null;
